    ...
    return (
        <>
            ...
            <View style={styles.container}>
                ...
                <RectButton style={styles.button}>
                    <Text style={styles.buttonText} onPress={handleConfirmDelivery}>Confirmar a Entrega </Text>
                </RectButton>
                <RectButton style={styles.button}>
                    <Text style={styles.buttonText} onPress={handleOnCancel}>Cancelar a Entrega </Text>
                </RectButton>
            </View>
        </>
    );
